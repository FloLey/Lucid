...
class TestSessionManager:
    ...
    def test_create_session(self):
        ...
        session_manager.clear_all()
        session = session_manager.create_session("test-001")
    ...
    def test_create_existing_session(self):
        ...
        session_manager.clear_all()
        session1 = session_manager.create_session("test-002")
        session2 = session_manager.create_session("test-002")
        assert session1 is session2

    def test_get_session(self):
        """Test getting a session."""
        session_manager.clear_all()
        session_manager.create_session("test-003")
        session = session_manager.get_session("test-003")
    ...
    def test_delete_session(self):
        ...
        session_manager.clear_all()
        session_manager.create_session("test-004")
        assert session_manager.delete_session("test-004") is True
        assert session_manager.get_session("test-004") is None
    ...
    def test_advance_stage(self):
        ...
        session_manager.clear_all()
        session_manager.create_session("test-005")
        session = session_manager.advance_stage("test-005")
    ...
    def test_go_to_stage(self):
        ...
        session_manager.clear_all()
        session_manager.create_session("test-007")
        session = session_manager.go_to_stage("test-007", 3)
        assert session.current_stage == 3
